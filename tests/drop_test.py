...
class TestDropApply:
    ...
    def test_success_drop_to_drop_area_apply(self):
        expected_scene = Scene()
        expected_scene.players_points["test"] = {"Wood": 2, "Stone": 1}
        expected_dummy_object = Object(id=1, name="dummy", owner="test", position=Vector(5, 5))
        expected_dummy_drop = Drop(target_position=Vector(5, 6), object_id=1, drop_area_position=Vector(5, 6))
        ...
        scene = Scene()
        scene.players_points["test"] = {"Wood": 0, "Stone": 0}
